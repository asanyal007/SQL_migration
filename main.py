...
gcp_client = API_Check.gcpClient('onyx-sequencer-297412', 'onyx-sequencer-297412-67e580bc8161.json', dryRun=False, use_query_cache=False)
...
gcp_client = API_Check.gcpClient('onyx-sequencer-297412', 'onyx-sequencer-297412-67e580bc8161.json', dryRun=True, use_query_cache=False)
client, jobconfig = gcp_client.api_config()
gcp_api = API_Check.gcpAPIChecks(client, jobconfig)
...
gcp_client = API_Check.gcpClient('onyx-sequencer-297412', 'onyx-sequencer-297412-67e580bc8161.json', False, False)
client, jobconfig = gcp_client.api_config()
